...
import seederData from "./partsinventory.seeder.json";
...
const PartsinventorySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PartsinventorySeederDialogComponent);
