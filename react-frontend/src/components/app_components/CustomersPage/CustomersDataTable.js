...
const dropdownTemplate0 = (rowData, { rowIndex }) => <p >{rowData.firstName?.password}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.lastName}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.email}</p>
const dropdownTemplate3 = (rowData, { rowIndex }) => <p >{rowData.phoneNumber?.number}</p>
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.address}</p>
const p_numberTemplate5 = (rowData, { rowIndex }) => <p >{rowData.joinDate}</p>
const p_numberTemplate6 = (rowData, { rowIndex }) => <p >{rowData.loyaltyPoints}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="firstName" header="FirstName" body={dropdownTemplate0} filter={selectedFilterFields.includes("firstName")} hidden={selectedHideFields?.includes("firstName")}  style={{ minWidth: "8rem" }} />
...
<Column field="phoneNumber" header="PhoneNumber" body={dropdownTemplate3} filter={selectedFilterFields.includes("phoneNumber")} hidden={selectedHideFields?.includes("phoneNumber")}  style={{ minWidth: "8rem" }} />
...
<Column field="joinDate" header="JoinDate" body={p_numberTemplate5} filter={selectedFilterFields.includes("joinDate")} hidden={selectedHideFields?.includes("joinDate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="loyaltyPoints" header="LoyaltyPoints" body={p_numberTemplate6} filter={selectedFilterFields.includes("loyaltyPoints")} hidden={selectedHideFields?.includes("loyaltyPoints")}  sortable style={{ minWidth: "8rem" }} />
