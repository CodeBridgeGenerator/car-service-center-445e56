...
import seederData from "./oilchangerecords.seeder.json";
...
const OilchangerecordsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(OilchangerecordsSeederDialogComponent);
