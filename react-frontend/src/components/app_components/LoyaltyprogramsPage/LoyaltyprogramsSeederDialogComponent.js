...
import seederData from "./loyaltyprograms.seeder.json";
...
const LoyaltyprogramsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LoyaltyprogramsSeederDialogComponent);
