...
import seederData from "./maintenanceschedules.seeder.json";
...
const MaintenanceschedulesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MaintenanceschedulesSeederDialogComponent);
