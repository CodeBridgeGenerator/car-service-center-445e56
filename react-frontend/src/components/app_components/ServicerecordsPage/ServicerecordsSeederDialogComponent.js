...
import seederData from "./servicerecords.seeder.json";
...
const ServicerecordsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ServicerecordsSeederDialogComponent);
