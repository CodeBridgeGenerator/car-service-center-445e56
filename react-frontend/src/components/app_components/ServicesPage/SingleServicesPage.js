...
const SingleServicesPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("services")
            .get(urlParams.singleServicesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleServicesId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>services/{urlParams.singleServicesId}</p> */}
            </div>
            <div className="card w-full">
                <div className="grid ">

            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">ServiceName</label><p className="m-0 ml-3" >{_entity?.serviceName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Duration</label><p className="m-0 ml-3" >{Number(_entity?.duration)}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleServicesId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleServicesPage);
