...
import seederData from "./services.seeder.json";
...
const ServicesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ServicesSeederDialogComponent);
