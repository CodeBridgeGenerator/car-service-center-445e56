...
description: _entity?.description,
        ...
        const result = await client.service("paymentmethods").patch(_entity._id, _data);
        props.onHide();
    ...
    return (
        <Dialog header="Edit Payment methods" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
