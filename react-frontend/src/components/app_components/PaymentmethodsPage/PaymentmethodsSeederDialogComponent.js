...
import seederData from "./paymentmethods.seeder.json";
...
const PaymentmethodsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PaymentmethodsSeederDialogComponent);
