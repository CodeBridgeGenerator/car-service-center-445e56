...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.supplierName}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.contactPerson}</p>
...
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.address}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="supplierName" header="SupplierName" body={pTemplate0} filter={selectedFilterFields.includes("supplierName")} hidden={selectedHideFields?.includes("supplierName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="contactPerson" header="ContactPerson" body={pTemplate1} filter={selectedFilterFields.includes("contactPerson")} hidden={selectedHideFields?.includes("contactPerson")}  sortable style={{ minWidth: "8rem" }} />
<Column field="phoneNumber" header="PhoneNumber" body={pTemplate2} filter={selectedFilterFields.includes("phoneNumber")} hidden={selectedHideFields?.includes("phoneNumber")}  sortable style={{ minWidth: "8rem" }} />
