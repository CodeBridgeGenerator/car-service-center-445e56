...
const TechniciansDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.specialization}</p>
...
<Column field="phoneNumber" header="PhoneNumber" body={pTemplate3} filter={selectedFilterFields.includes("phoneNumber")} hidden={selectedHideFields?.includes("phoneNumber")}  sortable style={{ minWidth: "8rem" }} />
<Column field="specialization" header="Specialization" body={pTemplate4} filter={selectedFilterFields.includes("specialization")} hidden={selectedHideFields?.includes("specialization")}  sortable style={{ minWidth: "8rem" }} />
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload Technicians Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search Technicians" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default TechniciansDataTable;