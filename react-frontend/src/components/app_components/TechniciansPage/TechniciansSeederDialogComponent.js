...
import seederData from "./technicians.seeder.json";
...
const TechniciansSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TechniciansSeederDialogComponent);
