...
const SingleTechniciansPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("technicians")
            .get(urlParams.singleTechniciansId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleTechniciansId]);
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Technicians</h3>
                    <SplitButton
                ...
                {/* <p>technicians/{urlParams.singleTechniciansId}</p> */}
            </div>
            <div className="card w-full">
                <div className="grid ">

            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">FirstName</label><p className="m-0 ml-3" >{_entity?.firstName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">PhoneNumber</label><p className="m-0 ml-3" >{_entity?.phoneNumber}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Specialization</label><p className="m-0 ml-3" >{_entity?.specialization}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleTechniciansId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleTechniciansPage);
